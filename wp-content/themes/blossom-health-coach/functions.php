...
function blossom_health_coach_customize_register( $wp_customize ){
    ...
    $theme_info .= '</p><p>';
    $theme_info .= sprintf( __( 'Documentation Link: %1$sClick here.%2$s', 'blossom-health-coach' ),  '<a href="' . esc_url( 'https://blossomthemes.com/blossom-health-coach-free-theme-documentation/' ) . '" target="_blank">', '</a>' );
    $theme_info .= '</p>';
    ...
    <div class="bottom-footer">
		<div class="wrapper">
            ...
            <?php
                ...
                echo '<a href="' . esc_url( 'https://blossomthemes.com/downloads/blossom-health-coach-free-wordpress-theme/' ) .'" rel="author" target="_blank">' . esc_html__( ' Blossom Health Coach', 'blossom-health-coach' ) . '</a>' . esc_html__( ' by Blossom Themes.', 'blossom-health-coach' );                

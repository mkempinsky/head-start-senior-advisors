        ...
        <div class="header-t">
			...
			<?php
                ...
                if( blossom_coach_social_links( false ) || $ed_search ){
                    ...
                    if( $ed_search ){
                        echo '<div class="header-search"><span><i class="fa fa-search"></i></span><div class="header-search-form">';
                        get_search_form();
                        echo '<span class="close"></span></div></div><!-- .header-seearch -->';
                    }	
				    echo '</div><!-- .top-right -->';
                } 
            ?>
...
function blossom_coach_post_thumbnail(){
    ...
    if( is_home() ){
        ...
        if( has_post_thumbnail() ){
            ...
            echo '<img src="' . esc_url( get_template_directory_uri() . '/images/' . $image_size . '.jpg'  ) . '" alt="' . esc_attr( strip_tags( get_the_title() ) ) . '" itemprop="image" />';
        }
        echo '</a>';
        ...
        if( has_post_thumbnail() ){
            ...
            echo '<img src="' . esc_url( get_template_directory_uri() . '/images/blossom-coach-blog.jpg'  ) . '" alt="' . esc_attr( strip_tags( get_the_title() ) ) . '" itemprop="image" />';
        }
        echo '</a>';
    }elseif( is_singular() ){
        $image_size = ( $sidebar ) ? 'blossom-coach-with-sidebar' : 'blossom-coach-fullwidth';
...
function blossom_coach_entry_header(){ 
    ...
    <header class="<?php echo esc_attr( $class ); ?>">
		<?php 
            ...
            if( is_singular() ){
                if( ! $ed_cat_single ) blossom_coach_category();
            }else{
            ...
            if( is_single() && 'post' === get_post_type() ){
                echo '<div class="entry-meta">';                
                if( is_single() ){
                    if( ! $ed_post_date ) blossom_coach_posted_on();
                }else{
                    blossom_coach_posted_on();
                }
                if( !$ed_post_author ) blossom_coach_posted_by();
						...
						<a href="<?php echo esc_url( get_permalink( $prev_post->ID ) ); ?>" rel="prev">
							...
							<figure>
                                ...
                                if( $prev_img ){
                                    ...
                                    echo '<img src="' . esc_url( get_template_directory_uri() . '/images/thumbnail.jpg' ) . '" alt="' . esc_attr( strip_tags( get_the_title( $prev_post->ID ) ) ) . '">'; //fallback
                                }
                                ?>
                            </figure>
						...
						<a href="<?php echo esc_url( get_permalink( $next_post->ID ) ); ?>" rel="next">
							...
							<figure>
                                ...
                                if( $next_img ){
                                    ...
                                    echo '<img src="' . esc_url( get_template_directory_uri() . '/images/thumbnail.jpg' ) . '" alt="' . esc_attr( strip_tags( get_the_title( $next_post->ID ) ) ) . '">'; //fallback
                                }
                                ?>
                            </figure>
    ...
    <div class="bottom-footer">
		<div class="wrapper">
            ...
            <?php
                ...
                echo '<a href="' . esc_url( 'https://blossomthemes.com/downloads/blossom-coach/' ) .'" rel="author" target="_blank">' . esc_html__( ' Blossom Coach', 'blossom-coach' ) . '</a>' . esc_html__( ' by Blossom Themes.', 'blossom-coach' );                

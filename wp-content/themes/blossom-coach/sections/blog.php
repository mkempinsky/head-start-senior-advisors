...
$title    = get_theme_mod( 'blog_section_title', __( 'Latest Articles', 'blossom-coach' ) );
        				...
        				<figure class="post-thumbnail">
                            ...
                            <?php 
                                if( has_post_thumbnail() ){
                                    ...
                                    <img src="<?php echo esc_url( get_template_directory_uri() . '/images/blossom-coach-latest.jpg' ); ?>" alt="<?php the_title_attribute(); ?>" />
                                <?php 
                                }                            
                            ?>                        
                            </a>                            

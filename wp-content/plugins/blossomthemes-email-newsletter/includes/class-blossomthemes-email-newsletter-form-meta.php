...
class BlossomThemes_Email_Newsletter_Form_Meta
{
    function __construct()
    {
        ...
        add_action( 'add_meta_boxes', array($this, 'blossomthemes_email_newsletter_add_subscriber_meta_boxes' ) );
        add_action( 'save_post', array($this, 'blossomthemes_email_newsletter_save_subscriber_data' ) );
  ...
  /**
    ...
    * @since 1.0
    */
    function blossomthemes_email_newsletter_add_subscriber_meta_boxes(){
        $screens = array( 'subscriber' );
        foreach ( $screens as $screen ) {
            add_meta_box(
                'subscriber_id',
                __( 'Subscriber Details', 'blossomthemes-email-newsletter' ),
                array($this,'blossomthemes_email_newsletter_subscriber_metabox_callback'),
                $screen,
                'normal',
                'high'
            );
    ...
    // Form settings
    public function blossomthemes_email_newsletter_subscriber_metabox_callback(){
        include BLOSSOMTHEMES_EMAIL_NEWSLETTER_BASE_PATH.'/includes/setting/subscriber-meta.php';
    }
     ...
     * @param int $post_id The ID of the post being saved.
     */
    function blossomthemes_email_newsletter_save_subscriber_data( $post_id ) {

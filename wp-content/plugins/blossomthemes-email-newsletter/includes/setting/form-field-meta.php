...
<div class="trip-info-meta">
	<div class="trip-info-meta-wrap">
		<label for="blossomthemes_email_newsletter_setting[field][uname-email]"><?php _e('Name and Email: ','blossomthemes-email-newsletter');?></label>
		<input type="radio" id="blossomthemes_email_newsletter_setting[field][uname-email]" name="blossomthemes_email_newsletter_setting[field][select]" value="uname-email" <?php if( $val == 'uname-email' ){echo "checked";}?>>
	</div>
	<div class="trip-info-meta-wrap">
		<label for="blossomthemes_email_newsletter_setting[field][email]"><?php _e('Email: ','blossomthemes-email-newsletter');?></label>
		<input type="radio" id="blossomthemes_email_newsletter_setting[field][email]" name="blossomthemes_email_newsletter_setting[field][select]" value="email" <?php if( $val == 'email' ){echo "checked";}?>>
	</div>
	<div class="trip-info-meta-wrap">
	...
	<div class="trip-info-meta-wrap">
        ...
        <input type="checkbox" class="blossomthemes-email-newsletter-gdpr" id="blossomthemes_email_newsletter_setting[appearance][gdpr]" name="blossomthemes_email_newsletter_setting[appearance][gdpr]" value="0" <?php echo checked($gdpr,1);?>>
    </div>
	<div class="trip-info-meta-wrap">
		<label for="blossomthemes_email_newsletter_setting[appearance][note]"><?php _e('Form Note: ','blossomthemes-email-newsletter');?></label>	
		...
		<div class="blossomthemes-email-newsletter-note"><?php _e('Short note to show above the input fields of the form.','blossomthemes-email-newsletter') ?></div>
	</div>
</div>